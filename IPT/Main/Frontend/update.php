...
?>
    ...
    <head>
        ...
        <!-- Title -->
        <title>Sewn-Up Update-items</title>
                    ...
                    <?php 
                        if(isset($_POST['update'])){
                            ...
                            $user_id= $_POST['id'];
                                ...
                                $query ="update inv_tbl set product_no = '$product_no', product_name = '$product_name', description = '$description', quantity = '$quantity' where id='$user_id' ";
                        ...
                        <div class="main-wrapper">
                            <div class="row">
                                <div class="col">
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 class="card-title">Update Items</h5>
                                            ...
                                            <form class="row g-3 needs-validation" method="post" action="" enctype="multipart/form-data">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" name="product_no" placeholder="Code" value="<?php echo $product_no; ?>" required>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" name="product_name" placeholder="Name" value="<?php echo $product_name; ?>" required>
                                                    <div class="valid-feedback">
                                                        Looks good!
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <button class="btn btn-primary" type="submit" value="Update" name="update" >Update Item</button>
                                                    <a  onclick="if(confirm('Are you sure you want to cancel?')) history.back();" class="btn btn-primary" >Cancel</a>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
